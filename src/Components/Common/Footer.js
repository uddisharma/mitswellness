          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-3 col-md-3">
                ...
                <p className="mb-0">
                  <a className="text-dark" href="#">
                    Plot 176, Basement, Industrial Area Phase 1, Panchkula,
                    Haryana 134113
                  </a>
                </p>
              </div>
              ...
              <div className="col-lg-3 col-md-3">
                {/* <h6 className="mb-4">More Queries</h6>
                <TextField
                  id="outlined-basic"
                  label="Email"
                  variant="outlined"
            ...
            <div className="row no-gutters">
              <div className="col-lg-6 col-sm-6">
                <p className="mt-1 mb-0">
                  © Copyright 2023{" "}
                  <strong className="text-dark">MITS Wellness</strong>. All
                  Rights Reserved
                  <br />
